...
bindsym $mod+c [title="c4lc"] scratchpad show, move position center
...
for_window [title="c4lc"] move scratchpad
...
set $mode_screen (n)ormal, (e)xtended, (d)ual, (o)nly
mode "$mode_screen" {
	bindsym n exec --no-startup-id /home/user/.configme/monitor_off.sh
	bindsym e exec --no-startup-id /home/user/.configme/monitor_right.sh
	bindsym d exec --no-startup-id /home/user/.configme/monitor_dual.sh
	bindsym o exec --no-startup-id /home/user/.configme/monitor_only.sh
...
exec_always --no-startup-id urxvt -T 'c4lc' -e 'python' 
